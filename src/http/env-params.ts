...
export const ENV_PARAMS: EnvParam[] = [
  ...
  { key: 'LINE_RICH_MENU_EN', requiredIn: [], note: 'Rich-menu id for English tray; LANG links this PNG' },
  { key: 'LINE_RICH_MENU_TH', requiredIn: [], note: 'Rich-menu id for Thai tray; LANG links this PNG' },
