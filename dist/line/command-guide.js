...
exports.buildCommandKeywordGuidance = exports.buildStepByStepGuide = exports.isGuideCommand = void 0;
const COMMAND_SPECS = [
...
const buildStepByStepGuide = (language, agentName) => {
    if (language === 'en') {
...
exports.buildStepByStepGuide = buildStepByStepGuide;
